...
public class reto1 {
    ...
    public static void main(String[] args) {
        ...
        for(int i=0;i<datosPacientes.length;i++){
            ...
            String diagnostico = paciente.getDiagnostico(naucea, vomito, 
                    dolorAbdominal, diarrea, fiebre);
        ...
        if(contDiagnostico1 > 0 || contDiagnostico2 > 0 || contDiagnostico3 > 0
                || contDiagnostico4 > 0 || contDiagnostico5 > 0){
